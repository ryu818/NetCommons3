	...
	<div id="controls-panel">
		<?php foreach ($modules as $module): ?>
			...
			<div class="controls-system-icon">
				<a class="controls-system-link" href="<?php echo($this->Html->url('/').'active-controls/'.$module['Module']['controller_action']);?>" data-ajax="#_system<?php echo($module['Module']['id']); ?>" data-ajax-method='inner' data-ajax-dialog='true' data-ajax-dialog-options='{"title" : "<?php echo($module_name); ?>","position": "mouse"}' data-ajax-effect="fold" data-ajax-dialog-class="controls-module <?php echo(Inflector::underscore($module['Module']['dir_name'])); ?>-dialog">
