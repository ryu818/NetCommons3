...
// Add for NetCommons Extentions By Ryuji.M --START
            contentClass      : 'dd-handle',
            singleHandleClass : '',
            active            : '',
            activeItemClass   : 'dd-active',
            placeClass        : 'dd-placeholder',
            placeUpClass      : 'dd-placeholder-up',
            placeDownClass    : 'dd-placeholder-down',
            containment       : null,
            isInner           : true,
...
// IE8でAjaxを用いて画面を表示した場合、CSSの描画が終わった後にjavascriptが実行されずにCSSが適用されなくなる場合があるため修正。
		if ( !window.DOMParser ) {
        	var t = this;
        	setTimeout(function(){
        		t.init();
