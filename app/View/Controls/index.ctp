	...
	<div id="controls-panel">
		<?php foreach ($modules as $module): ?>
			...
			<div class="controls-system-icon">
				<a class="controls-system-link" href="<?php echo($this->Html->url('/').'active-controls/'.$module['Module']['controller_action']);?>" data-ajax="" data-ajax-dialog-id="_system<?php echo($module['Module']['id']); ?>" data-ajax-dialog-options='{"title" : "<?php echo($module_name); ?>","position": "mouse"}' data-ajax-effect="fold">
