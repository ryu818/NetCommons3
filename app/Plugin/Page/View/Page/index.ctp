<div id="nc-pages-setting-dialog">
	<div class="nc-pages-setting-icon table_cell nc_popup_color">
		...
		array('title' => __d('page', 'Pages menu'), 'class' => 'nc-pages-menu-icon' . $postfix . ' nc_tooltip',
			'data-powertip' => __d('page', 'Displays the menu for displaying and editing the page list, the community.'), 'data-ajax-replace' => '#nc-pages-setting-dialog'));
		...
		array('title' => __d('page', 'Pages favorite'), 'class' => 'nc-pages-favorite-icon' . $postfix . ' nc_tooltip',
			'data-powertip' => __d('page', 'I display the list of pages that oneself looks at well.'), 'data-ajax-replace' => '#nc-pages-setting-dialog'));
		...
		array('title' => __d('page', 'Page info'), 'class' => 'nc-page-metas-icon' . $postfix . ' nc_tooltip',
			'data-powertip' => __d('page', 'I can edit the page title, the description of the page, the keyword.'), 'data-ajax-replace' => '#nc-pages-setting-dialog'));
		...
		array('title' => __d('page', 'Page theme'), 'class' => 'nc-page-themes-icon' . $postfix . ' nc_tooltip',
			'data-powertip' => __d('page', 'I can change the design of the page.'), 'data-ajax-replace' => '#nc-pages-setting-dialog'));
		...
		array('title' => __d('page', 'Page style'), 'class' => 'nc-page-styles-icon' . $postfix . ' nc_tooltip',
			'data-powertip' => __d('page', 'I can change the page style color, and font.'), 'data-ajax-replace' => '#nc-pages-setting-dialog'));
		...
		array('title' => __d('page', 'Page layout'), 'class' => 'nc-page-layouts-icon' . $postfix . ' nc_tooltip',
			'data-powertip' => __d('page', 'I can switch the display and non-display of up, down, left, or right column.'), 'data-ajax-replace' => '#nc-pages-setting-dialog'));
		?>
	</div>
