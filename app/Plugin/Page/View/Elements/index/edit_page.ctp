	...
	<?php foreach ($menus as $menu): ?>
		...
		<li class="dd-item">
			...
			<?php if(!empty($pages[$space_type][$root_sequence][$next_thread_num][$menu['id']])): ?>
				<ol class="dd-list">
					<?php echo($this->element('index/edit_page', array('pages' => $pages, 'menus' => $pages[$space_type][$root_sequence][$next_thread_num][$menu['id']], 'page_id' => $page_id, 'space_type' => $space_type, 'root_sequence' => $root_sequence))); ?>
				</ol>
			<?php endif; ?>
		</li>
	<?php endforeach; ?>
