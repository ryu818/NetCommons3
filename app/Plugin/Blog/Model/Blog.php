	...
	public function findDefault($content_id) {
		$ret = array(
			'Blog' => array(
				...
				'comment_mail_subject' => __d('blog', "[{X-SITE_NAME}]Blog Comment({X-ROOM} {X-BLOG_NAME} {X-SUBJECT})"),
				...
				'transmit_blog_name' => __d('blog', "{X-BLOG_NAME}-{X-SITE_NAME}"),
				'approved_flag' => _OFF,
				'approved_mail_flag' => _OFF,
				'approved_mail_subject' => __d('blog', "[{X-SITE_NAME}]Post Approval completion notice"),
				'approved_mail_body' => __d('blog', "Your article posted to {X-SITE_NAME} was approved.\nIf you did not post one, just delete this email. \n\nClick the link below to check the article.\n{X-URL}"),
				'comment_approved_flag' => _OFF,
				'comment_approved_mail_flag' => _OFF,
				'comment_approved_mail_subject' => __d('blog', "[{X-SITE_NAME}]Comment, trackback Approval completion notice"),
				'comment_approved_mail_body' => __d('blog', "Your comment and trackback posted to {X-SITE_NAME} was approved.\nIf you did not post one, just delete this email. \n\nClick the link below to check the article.\n{X-URL}"),
			),
		);
