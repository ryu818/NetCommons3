		...
		var options = $.extend({
	            ...
	            html            :
	            	'<div class="nc-wysiwyg-insertlink-title">'+ __d('nc_wysiwyg_insertlink', 'dialog_title') +'</div>' +
				  		...
				  		'</ul><div class="nc-wysiwyg-insertlink-btn"><input id="nc-wysiwyg-insertlink-ok" class="nc-common-btn" name="ok" type="button" value="' + __d('nc_wysiwyg_insertlink', 'ok') + '" />' +
				  	'&nbsp;<input id="nc-wysiwyg-insertlink-cancel" name="cancel" class="nc-common-btn" type="button" value="' + __d(['nc_wysiwyg', 'dialog'], 'cancel') + '" /></div>'
	        }, options);
