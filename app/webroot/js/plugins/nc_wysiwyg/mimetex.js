  ...
  ;(function($) {
	$.fn.nc_mimetex = function(e, options) {
		...
		function init() {
			...
			ok			= $('<input name="ok" type="button" class="nc-common-btn" value="'+__d(['nc_wysiwyg', 'dialog'], 'ok')+'" />').appendTo(upload);
			cancel		= $('<input name="cancel" type="button" class="nc-common-btn" value="'+__d(['nc_wysiwyg', 'dialog'], 'cancel')+'" />').appendTo(upload);
